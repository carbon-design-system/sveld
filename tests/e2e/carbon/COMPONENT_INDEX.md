...
| icon | No | <code>let</code> | No | -- | <code>any</code> | <code>undefined</code> | Specify the icon to render.<br />Alternatively, use the named slot "icon".<br />@example <pre><code>&lt;Button><br />  &lt;Icon slot="icon" size={20} /><br />&lt;/Button></code></pre> |
...
| hideTooltip | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | Set to `true` to hide the tooltip while maintaining accessibility.<br />Only applies to icon-only buttons.<br />When `true`, the tooltip is visually hidden but the `iconDescription` remains accessible to screen readers. |
| as | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | Set to `true` to render a custom HTML element.<br />Props are destructured as `props` in the default slot.<br />@example <pre><code>&lt;Button let:props><br />  &lt;div {...props}>Custom Element&lt;/div><br />&lt;/Button></code></pre> |
| skeleton | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | Set to `true` to display the skeleton state |
...
| <s>small</s><br />**Deprecated**: this prop will be removed in the next major release Use size="small" instead | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | -- |
...
export interface ColumnSizeDescriptor {span?: ColumnSize; offset: number;}
...
```ts
export interface ComboBoxItem { id: string; text: string; }
```
...
export interface DataTableEmptyHeader<Row> { key: DataTableKey<Row>; empty: boolean; display?: (item: Value, row: Row) => DataTableValue; sort?: false | ((a: DataTableValue, b: DataTableValue) => number); columnMenu?: boolean; width?: string; minWidth?: string; }

export interface DataTableNonEmptyHeader<Row> { key: DataTableKey<Row>; value: DataTableValue; display?: (item: Value, row: Row) => DataTableValue; sort?: false | ((a: DataTableValue, b: DataTableValue) => number); columnMenu?: boolean; width?: string; minWidth?: string; }

export type DataTableHeader<Row> = DataTableNonEmptyHeader<Row> | DataTableEmptyHeader<Row>;

export interface DataTableRow { id: any; [key: string]: DataTableValue; }

export type DataTableRowId = any;

export interface DataTableCell { key: DataTableKey<Row>; value: DataTableValue; display?: (item: Value, row: DataTableRow) => DataTableValue; }
```
...
export interface DropdownItem { id: DropdownItemId; text: DropdownItemText; }
```
...
| clearFiles | No | <code>accessor</code> | No | -- | <code>() => void</code> | -- | Override the default behavior of clearing the array of uploaded files |
...
```ts
export interface HeaderActionSlideTransition { delay?: number; duration?: number; easing?: (t: number) => number; }
```
...
| Prop name | Required | Kind | Reactive | Binding | Type | Default value | Description |
| :- | :- | :- | :- | :- | :- | :- | :- |
| <s>ariaLabel</s><br />**Deprecated**: use "aria-label" instead | No | <code>let</code> | No | -- | <code>string</code> | <code>undefined</code> | Specify the ARIA label for the nav |
...
```ts
export interface HeaderSearchResult { href: string; text: string; description?: string; }
```
...
export interface MultiSelectItem { id: MultiSelectItemId; text: MultiSelectItemText; }
```
...
| focus | forwarded | -- | -- |
| keydown | forwarded | -- | -- |
| select | dispatched | <code>{ selectedIds: MultiSelectItemId[]; selected: any; unselected: any; }</code> | -- |
...
| icon | No | <code>let</code> | No | -- | <code>typeof import("carbon-icons-svelte").CarbonIcon</code> | <code>Close20</code> | Specify the icon from `carbon-icons-svelte` to render |
...
| ref | No | <code>let</code> | Yes | -- | <code>null &#124; HTMLInputElement</code> | <code>null</code> | Obtain a reference to the input HTML element |
| <s>small</s><br />**Deprecated**: this prop will be removed in the next major release Use size="sm" instead | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | -- |
...
| Prop name | Required | Kind | Reactive | Binding | Type | Default value | Description |
| :- | :- | :- | :- | :- | :- | :- | :- |
| <s>small</s><br />**Deprecated**: this prop will be removed in the next major release Set to `true` to use the small variant | No | <code>let</code> | No | -- | <code>boolean</code> | <code>false</code> | -- |
| size | No | <code>let</code> | No | -- | <code>"sm" &#124; "lg" &#124; "xl"</code> | <code>"xl"</code> | Specify the size of the search input |
...
| icon | No | <code>let</code> | No | -- | <code>typeof import("carbon-icons-svelte").CarbonIcon</code> | <code>Information16</code> | Specify the icon from `carbon-icons-svelte` to render for the tooltip button<br />Icon size must be 16px (e.g., `Add16`, `Task16`) |

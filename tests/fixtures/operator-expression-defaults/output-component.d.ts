...
export type OperatorExpressionDefaultsExports = Record<string, never>;

declare const OperatorExpressionDefaults: Component<
  OperatorExpressionDefaultsProps,
  OperatorExpressionDefaultsExports,
  ""
>;
export default OperatorExpressionDefaults;

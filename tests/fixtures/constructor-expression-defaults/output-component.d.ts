...
export type ConstructorExpressionDefaultsExports = Record<string, never>;

declare const ConstructorExpressionDefaults: Component<
  ConstructorExpressionDefaultsProps,
  ConstructorExpressionDefaultsExports,
  ""
>;
export default ConstructorExpressionDefaults;

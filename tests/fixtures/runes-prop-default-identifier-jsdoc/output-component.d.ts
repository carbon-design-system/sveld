...
export type RunesPropDefaultIdentifierJsdocExports = Record<string, never>;

declare const RunesPropDefaultIdentifierJsdoc: Component<
  RunesPropDefaultIdentifierJsdocProps,
  RunesPropDefaultIdentifierJsdocExports,
  ""
>;
export default RunesPropDefaultIdentifierJsdoc;

...
export type TypedefImportTypeExports = Record<string, never>;

declare const TypedefImportType: Component<
  TypedefImportTypeProps,
  TypedefImportTypeExports,
  ""
>;
export default TypedefImportType;
